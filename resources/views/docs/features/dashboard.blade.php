...
<div class="mb-8">
    ...
    <h1 class="text-4xl font-bold tracking-tight mb-3">Dashboard</h1>
    <p class="text-lg text-muted-foreground">Your financial command center - get a complete overview of your finances at a glance.</p>
</div>
